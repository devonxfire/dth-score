      ...
      <div className="max-w-4xl w-full min-h-screen flex flex-col justify-start p-0 text-white" style={{ fontFamily: 'Lato, Arial, sans-serif', boxSizing: 'border-box' }}>
        <div className="w-full h-full flex flex-col justify-start p-0 text-white" style={{ boxSizing: 'border-box', display: 'flex', justifyContent: 'center' }}>
          ...
          <div className="flex flex-col gap-2">
            <button className="w-full py-3 px-4 rounded-2xl font-bold shadow border border-white transition text-lg" style={{ backgroundColor: '#FFD700', color: '#002F5F', fontFamily: 'Lato, Arial, sans-serif', boxShadow: '0 2px 8px 0 rgba(27,58,107,0.10)' }} onClick={addGroup}>{groups.length === 0 ? 'Add A Tee Time' : 'Add Another Tee Time'}</button>
            <button className="w-full py-3 px-4 rounded-2xl font-bold shadow border border-white transition text-lg" style={{ backgroundColor: '#1B3A6B', color: 'white', fontFamily: 'Lato, Arial, sans-serif', boxShadow: '0 2px 8px 0 rgba(27,58,107,0.10)' }} onClick={handleSave} disabled={saving}>{saving ? 'Saving...' : 'Save & Continue'}</button>
          </div>
          </div>
            </div>
        </div>
