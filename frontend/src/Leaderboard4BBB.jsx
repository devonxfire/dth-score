          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 15 }}>
            <thead>
              <tr style={{ background: '#eee' }}>
                ...
                <th style={{ border: '1px solid #222', padding: 4, textAlign: 'center', verticalAlign: 'middle' }}>Points</th>
            ...
            <tbody>
              {players.map((p, idx) => (
                <tr key={p.name} style={{ background: idx % 2 === 0 ? '#f7f7f7' : '#fff' }}>
                  ...
                  <td style={{ border: '1px solid #222', padding: 4, textAlign: 'center', verticalAlign: 'middle' }}>{p.teamPoints ?? ''}</td>
                  ...
                  <table className="min-w-full border text-center mb-8" style={{ fontFamily: 'Lato, Arial, sans-serif', background: '#002F5F', color: 'white', borderColor: '#FFD700' }}>
                    <thead>
                      <tr style={{ background: '#00204A' }}>
                        ...
                        <th className="border px-2 py-0.5" style={{background:'#002F5F',color:'#FFD700', borderColor:'#FFD700', fontFamily:'Merriweather, Georgia, serif'}}>Points</th>
                    ...
                    <tbody>
                      {players.map((p, idx) => (
                        <tr key={p.name} className={idx % 2 === 0 ? 'bg-white/5' : ''}>
                          ...
                          <td className="border px-2 py-0.5">{p.teamPoints}</td>
